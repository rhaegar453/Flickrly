...
import {selectGroup} from '../store/Actions/index';
                ...
                <div class="gridblock">
                    ...
                    <div class="w-layout-grid grid-2">
                        {this.props.data.photos.map(item => (
                            <div key={item}>
                                <img src={item} id="w-node-c2b4d253d288-b7e90bd6" width={"100%"} height="100px" style={{ objectFit: 'cover' }} class="image-2"></img>
                            </div>
                        ))}
                    </div>
                </div>
